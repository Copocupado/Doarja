...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    ItemCard: typeof import('./components/CRUD_Itens/ItemCard.vue')['default']
    ...
    PedidoCardPedidoOnly: typeof import('./components/CRUD_Itens/pedidoCardPedidoOnly.vue')['default']
